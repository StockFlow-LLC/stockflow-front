    ...
    return (
        <div className="pb-[200px]" data-aos="fade-up">
            ...
            <div className="blogContainer mt-2">
                ...
                <h1 className="text-2xl md:text-5xl mt-[24px] mb-2" data-aos="fade-up" data-aos-delay="200">{blog.title}</h1>
                <p className="text-gray-400 mb-3" data-aos="fade-up" data-aos-delay="300">{blog.subtitle}</p>
