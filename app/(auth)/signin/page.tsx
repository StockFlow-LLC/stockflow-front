...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: any) => {
    ...
    formDataToSend.append('rememberMe', formData.rememberMe.toString())
  ...
  const handleGoogleLogin = async () => {
    try {
      ...
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL_BACK}/api/auth/google`, {
        method: 'POST',
      ...
      <div className="min-h-screen bg-black flex items-center justify-center p-4">
        <div className="w-full max-w-md space-y-8 bg-zinc-900 p-8 rounded-lg">
          ...
          <div className="text-center text-sm">
            ...
            <a href="/signup" className="text-white hover:text-zinc-200">
              Sign up
            </a>
          </div>
        </div>
