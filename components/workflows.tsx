        ...
        <div className="pb-12 md:pb-20">
          ...
          <div className="mx-auto max-w-3xl pb-12 text-center md:pb-20">
            ...
            <p className="text-lg text-white/65">
              Simple and elegant interface to research stocks based on niche data.
            </p>
          </div>
          {/* Spotlight items */}
                ...
                <div className="p-6">
                  <div className="mb-3">
                    <span className="btn-sm relative rounded-full bg-gray-800/40 px-2.5 py-0.5 text-xs font-normal before:pointer-events-none before:absolute before:inset-0 before:rounded-[inherit] before:border before:border-transparent before:[background:linear-gradient(to_bottom,theme(colors.gray.700/.15),theme(colors.gray.700/.5))_border-box] before:[mask-composite:exclude_!important] before:[mask:linear-gradient(white_0_0)_padding-box,_linear-gradient(white_0_0)] hover:bg-gray-800/60">
                      <span className="bg-gradient-to-r from-green-500 to-white bg-clip-text text-transparent">
                        Alternative Datasets
                      </span>
                    </span>
                  </div>
                  <p className="text-white/65">
                  Seamlessly integrate exclusive financial datasets—insider trades, government contracts, lobbying deals, and off-exchange activity—into your strategy. Stay ahead with the intelligence institutional investors rely on.
                  </p>
                </div>
              </div>
            </a>
            ...
            >
              <div className="relative z-20 h-full overflow-hidden rounded-[inherit] bg-gray-950 after:absolute after:inset-0 after:bg-gradient-to-br after:from-gray-900/50 after:via-gray-800/25 after:to-gray-900/50">
                ...
                <div className="p-6">
                  ...
                  <p className="text-white/65">
                  Access expert-curated screeners to instantly spot high-probability setups and emerging opportunities. From dark pool movements to unusual insider activity, track what truly matters.
                  </p>
                </div>
              </div>
            </a>
            ...
            >
              <div className="relative z-20 h-full overflow-hidden rounded-[inherit] bg-gray-950 after:absolute after:inset-0 after:bg-gradient-to-br after:from-gray-900/50 after:via-gray-800/25 after:to-gray-900/50">
                ...
                <div className="p-6">
                  ...
                  <p className="text-white/65">
                  Analyze institutional option flow to detect where the smart money is positioning itself.
                  Refine option sweeps, block trades, and unusual volume with precision—eliminate noise and act on real signals.
                  </p>
                </div>
              </div>
            </a>
