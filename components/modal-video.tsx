...
export default function ModalVideo({
  ...
  return (
    ...
    //   {/* Video thumbnail */}
    //   <button
    //     className="group relative flex items-center justify-center rounded-2xl focus:outline-none focus-visible:ring focus-visible:ring-white"
    //     onClick={() => {
    //       setModalOpen(true);
    //     }}
    ...
    //             >
    //               <stop stopColor="#0BDA51" />
    //               <stop offset={1} stopColor="#0BDA51" stopOpacity=".72" />
    //             </linearGradient>
    //           </defs>
    //         </svg>
